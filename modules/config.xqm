...
(:~~
 ...
 :)
declare variable $config:webcomponents :="1.33.1";
...
(:
 ...
 :)
declare variable $config:default-template :="escher.html";
...
(:~
 ...
 :)
declare variable $config:odd-available :=("docbook.odd", "escher.odd");
...
declare variable $config:default-fields := ("date","type", "name", "lname", "person-note");
